...
export const blueprints: Blueprint[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'guardrails_input', label: 'Input Guardrails', type: 'validate', icon: 'shield-check', x: 800, y: 150, status: 'dormant', description: 'NeMo Guardrails checking input safety' },
      { id: 'generation', label: 'NIM Generation', type: 'execute', icon: 'cpu', x: 950, y: 250, status: 'dormant', description: 'NVIDIA NIM LLM generating response with context' },
      { id: 'guardrails_output', label: 'Output Guardrails', type: 'validate', icon: 'check-circle', x: 800, y: 350, status: 'dormant', description: 'NeMo Guardrails validating output safety' },
      { id: 'output', label: 'Response Ready', type: 'output', icon: 'upload', x: 950, y: 350, status: 'dormant', description: 'Final response with citations delivered' },
    ],
    connections: [
      ...
      { from: 'context_assembly', to: 'guardrails_input' },
      { from: 'guardrails_input', to: 'generation' },
      { from: 'generation', to: 'guardrails_output' },
      { from: 'guardrails_output', to: 'output' },
    ],
    scenarios: [
      {
        id: 'realtime',
      ...
      },
      {
        ...
        activeNodes: ['intake', 'embedding', 'retrieval', 'reranking', 'context_assembly', 'guardrails_input', 'generation', 'guardrails_output', 'output'],
        events: [
          {
            id: 'event-1',
          ...
          {
            id: 'event-6',
            message: 'Input guardrails check: Passed ✓',
            timing: 290,
            status: 'completed',
            nodeIds: ['guardrails_input'],
          },
          {
            id: 'event-7',
          ...
          {
            id: 'event-9',
            message: 'Output guardrails check: Passed ✓',
            timing: 3345,
            status: 'completed',
            nodeIds: ['guardrails_output'],
          },
          {
            id: 'event-10',
      ...
      },
      {
        ...
        events: [
          ...
          {
            id: 'event-6',
            message: 'Input guardrails: Compliance topic detected, elevated scrutiny enabled',
            timing: 260,
            status: 'completed',
            nodeIds: ['guardrails_input'],
          },
          ...
          {
            id: 'event-9',
            message: 'Output guardrails: Verifying accuracy and policy adherence',
            timing: 2830,
            status: 'completed',
            nodeIds: ['guardrails_output'],
          },
          {
            id: 'event-10',
            message: 'All guardrails passed. Response delivered.',
            timing: 2860,
            status: 'completed',
            nodeIds: ['output'],
          },
